...
$config['dbTableNames']['online']		= 'chat_online';
$config['dbTableNames']['messages']		= 'chat_messages';
$config['dbTableNames']['bans']			= 'chat_bans';
$config['dbTableNames']['invitations']	= 'chat_invitations';
...
$config['contentEncoding'] = $default_charset;
// The encoding of the data source, like userNames and channelNames:
$config['sourceEncoding'] = $default_charset;
